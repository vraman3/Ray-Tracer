...
public:
	...
	ColourClass TraceRay_2debug(RayClass ray_d, std::vector<ObjectClass*> objects_d);
	bool TraceRay_2debug_helper(RayClass ray_d, std::vector<ObjectClass*> objects_d, double tMin_d, double tMax_d, intersection_record &rec_d);
